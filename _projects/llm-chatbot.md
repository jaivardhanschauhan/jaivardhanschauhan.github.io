...
Having seen my meticulous lawyer friends dig through dense, jargon-heavy legal documents, I built a RAG-based chatbot to make legal research faster and easier. The tool lets users upload multiple legal PDFs, ask questions, and receive grounded responses with direct citations from the source texts. If the question is out of scope or unclear, the chatbot is less prone to hallucinations because of the pipeline nature and prompting technique - it may simply say, *'I don’t know the answer.'* This behavior contrasts with generic language models, where memory is temporary and hallucinations are more common. Hence, such RAG based systems are also scalable.
